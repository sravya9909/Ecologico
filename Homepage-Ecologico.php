...
<body>
	...
	<div class="part_1">
		...
		<form class="search" method="post">
			<input type="text" name="search" placeholder="Search for products and more" class="search_text">
			<button type="submit" name="submit" value="T" class="search_button"><i class="fa fa-search" aria-hidden="true"></i></button>
		</form>
...
<div class="carousel-wrapper">
    <div class="carousel" data-flickity>
      ...
      <div class="carousel-cell">
        ...
        <a class="more" href="decoritems.php">Explore Now</a>
        <img src="wooven-bamboo-round-shaped-ceiling-fan.jpg">
...
{
	$str = $_POST["search"];
	$sth = $db->prepare("SELECT * FROM `search` WHERE c_name='$str'");
	...
	if ($row = $sth->fetch())
	{
		 echo "<script> window.location = '$row->W_link' </script>";
	}
}
?>