...
<head>
	<meta charset="utf-8">
	<title>Ecologico | Kitchen</title>
</head>
<script src="heart.js"></script>
<link rel="stylesheet" href="kitchenitems2.css">
...
<body>
	...
	<ul class="home_list">
        ...
        <li class="cool-link BC"><a href="#">Profile &#9662;</a>
            <ul class="dropdown">
                ...
                <li class="common cool-link"><a href="logreg.html"><i style="color: #b3b3b3;" class="fa fa-sign-in" aria-hidden="true"></i>  Sign In / <i style="color: #b3b3b3;" class="fa fa-user-plus" aria-hidden="true"></i> Sign Up</a></li>
	...
	<div class="container">
		...
		<div class="row">
			<?php
		  include('server.php');
		  $stmt = $db->prepare("SELECT * FROM kitchen");
		  $stmt->execute();
     ...
     <img src="<?= $row['p_image'] ?>">
		...
		<div class="page-btn">
			<a href="kitchenitems.php"><span>&#8592;</span></a>
			<a href="kitchenitems.php"><span>1</span></a>
			<a href="kitchenitems2.php"><span class="active">2</span></a>
		</div>
	</div>
